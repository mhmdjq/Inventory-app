...
class _SearchByIdState extends State<SearchById> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: MyTitleText('Search By ID'),
                          ...
                          children: [
                            ...
                            TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: 'Enter item ID (e.g., 123)',
  ...
  void _search() {
    ...
    if (id.isNotEmpty) {
      context.read<ItemDatabase>().searchByID(id);

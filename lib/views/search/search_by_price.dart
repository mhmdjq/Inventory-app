...
class SearchByPrice extends StatefulWidget {
  const SearchByPrice({super.key});

  @override
  State<SearchByPrice> createState() => _SearchByPriceState();
}
...
class _SearchByPriceState extends State<SearchByPrice> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const MyTitleText('Search By Price'),
  ...
  void _search() {
    ...
    context.read<ItemDatabase>().searchByPrice(from, to);
